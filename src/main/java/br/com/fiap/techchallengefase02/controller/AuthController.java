...
import br.com.fiap.techchallengefase02.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<ApiSuccessResponse<TokenResponseDTO>> login(@RequestBody @Valid LoginRequestDTO dto) {
